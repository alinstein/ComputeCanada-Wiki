...
More information about this can be find [here](https://docs.computecanada.ca/wiki/SSH)
...
```
The procedure for creating virtual enviranment on your personal computer is differnt but simple.

More information about this can be find [here](https://docs.computecanada.ca/wiki/Python#Creating_and_using_a_virtual_environment)
...
```
More information about this can be find [here](https://docs.computecanada.ca/wiki/PyTorch)
### TensorFlow
The preferred option is to install it using the Python wheel as follows:
...
```
More information about this can be find [here](https://docs.computecanada.ca/wiki/TensorFlow)
### tensorboardX
...
More information about this can be find [here](https://docs.computecanada.ca/wiki/Transferring_data/en)

More conveniently, you can transfer data to and from Compute Canada with FileZilla software. Install the software with `sudo apt-get install filezilla` and then set up a connection with desired cluster as follows:
...
```
More information about this can be find [here](https://docs.computecanada.ca/wiki/Running_jobs#Use_sbatch_to_submit_jobs)
